  ...
  <div class="container">
    <el-row class="bt">
      <img
        v-if="showV1Image"
        style="width: 80%"
        src="@/assets/UIv1.0/大屏元素/顶部标题.png"
        alt="管理版标题"
      />
      <img v-else style="width: 80%" src="@/assets/UIv1.0/大屏元素/顶部标题2.png" alt="默认标题" />
...
const cs = () => {
  if (fromPath === '/article/manage') {
    showV1Image.value = true
    console.log(showV1Image.value)
  }
}
cs()
const tuichu = () => {
